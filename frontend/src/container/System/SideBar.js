            ...
            <nav className="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div className="sb-sidenav-menu">
                    <div className="nav">
                        ...
                        <Link to="/system/home" className="nav-link">
                            ...
                            <>
                                ...
                                <div className="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/system/home/list-user'} className="nav-link" >Danh sách người dùng</Link>
                                        <Link to={'/system/home/add-user'} className="nav-link" >Thêm người dùng</Link>
                                    </nav>
                                </div>
                                ...
                                <div className="collapse" id="collapseCategory" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/system/home/list-category'} className="nav-link" >Danh sách danh mục</Link>
                                        <Link to={'/system/home/add-category'} className="nav-link" >Thêm danh mục</Link>
                                    </nav>
                                </div>
                                ...
                                <div className="collapse" id="collapseBrand" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/system/home/list-brand'} className="nav-link" >Danh sách nhãn hàng</Link>
                                        <Link to={'/system/home/add-brand'} className="nav-link" >Thêm nhãn hàng</Link>
                                    </nav>
                                </div>
                                ...
                                <div className="collapse" id="collapseProduct" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/system/home/list-product'} className="nav-link" >Danh sách sản phẩm</Link>
                                        <Link to={'/system/home/add-product'} className="nav-link" >Thêm sản phẩm</Link>
                                    </nav>
                                </div>
                                ...
                                <div className="collapse" id="collapseBanner" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/system/home/list-banner'} className="nav-link" >Danh sách băng rôn</Link>
                                        <Link to={'/system/home/add-banner'} className="nav-link" >Thêm băng rôn</Link>
                                    </nav>
                                </div>
                                ...
                                <div className="collapse" id="collapseSubject" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/system/home/list-subject'} className="nav-link" >Danh sách chủ đề</Link>
                                        <Link to={'/system/home/add-subject'} className="nav-link" >Thêm chủ đề</Link>
                                    </nav>
                                </div>
                                ...
                                <div className="collapse" id="collapseBlog" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/system/home/list-blog'} className="nav-link" >Danh sách bài đăng</Link>
                                        <Link to={'/system/home/add-blog'} className="nav-link" >Thêm bài đăng</Link>
                                    </nav>
                                </div>
                                ...
                                <div className="collapse" id="collapseShip" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/system/home/list-typeship'} className="nav-link" >DS loại giao hàng</Link>
                                        <Link to={'/system/home/add-typeship'} className="nav-link" >Thêm loại giao hàng</Link>
                                    </nav>
                                </div>
                                ...
                                <div className="collapse" id="collapseVoucher" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/system/home/list-typevoucher'} className="nav-link" >DS loại khuyến mãi</Link>
                                        <Link to={'/system/home/list-voucher'} className="nav-link" >DS mã khuyến mãi</Link>
                                        <Link to={'/system/home/add-typevoucher'} className="nav-link" >Thêm loại khuyến mãi</Link>
                                        <Link to={'/system/home/add-voucher'} className="nav-link" >Thêm mã khuyến mãi</Link>
                                    </nav>
                                </div>
                            </>
                        }
                        ...
                        <div className="collapse" id="collapseSupplier" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav className="sb-sidenav-menu-nested nav">
                                <Link to={'/system/home/list-supplier'} className="nav-link" >Danh sách NCC</Link>
                                <Link to={'/system/home/add-supplier'} className="nav-link" >Thêm nhà cung cấp</Link>
                            </nav>
                        </div>
                        ...
                        <div className="collapse" id="collapseReceipt" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav className="sb-sidenav-menu-nested nav">
                                <Link to={'/system/home/list-receipt'} className="nav-link" >Danh sách nhập hàng</Link>
                                <Link to={'/system/home/add-receipt'} className="nav-link" >Thêm nhập hàng</Link>
                            </nav>
                        </div>
                        ...
                        <div className="collapse" id="collapseOrder" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav className="sb-sidenav-menu-nested nav">
                                <Link to={'/system/home/list-order'} className="nav-link" >Danh sách đơn hàng</Link>
                        ...
                        <div className="collapse" id="collapseMessage" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav className="sb-sidenav-menu-nested nav">
                                <Link to={'/system/home/chat'} className="nav-link" >Messenger</Link>
                        ...
                        {user && user.roleId === "R1" &&
                            <>
                                ...
                                <div className="collapse" id="collapseStatistic" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link to={'/system/home/turnover'} className="nav-link" >Thống kê doanh thu</Link>

                                        <Link to={'/system/home/profit'} className="nav-link" >Thống kê lợi nhuận</Link>
                                        <Link to={'/system/home/stock-product'} className="nav-link" >Thống kê tồn kho</Link>
